...
<body>
    ...
    <div class="main-container">
        ...
        <!-- Fetching car_id & order_id from url -->
        <?php 
        $car_id = $_GET['car_id'];
        ...
        <div class="payment-detail-conatiner">
            ...
            <div class="credit">
                <h2>Credit card</h2>
                <form action='<?php echo "car_order_processing.php?mode=Credit_card&car_id=".$car_id."&order_id=".$order_id;?>' method="post" id="payment-form">
                    ...
                    <input type="text" id="amount" name="amount" placeholder="10000.00" readonly>
                    <button type="submit" name="credit_btn">Pay Now</button>
                </form>
            </div>
            <!-- -------------------------------debit card--------------------------------------------------------- -->
            <div class="debit">
                <h2>Debit Card</h2>
                <form action="<?php echo "car_order_processing.php?mode=Debit_card&car_id=".$car_id."&order_id=".$order_id;?>" method="post" id="payment-form">
                    <label for="card-holder-name">Card Holder's Name</label>
                    <input type="text" id="card-holder-name" name="card-holder-name" placeholder="John Doe" required>
                    <label for="card-number">Card Number</label>
                    <input type="text" id="card-number" name="card-number" placeholder="1234 5678 9012 3456" maxlength="16" minlength="16" required>
                    ...
                    <label for="amount">Amount</label>
                    <input type="text" id="amount" name="amount" placeholder="10000.00" readonly>
                    <button type="submit" name="debit_btn">Pay Now</button>
                </form>
            </div>
            ...
            <div class="upi-form">
                ...
                <form action="<?php echo "car_order_processing.php?mode=UPI&car_id=".$car_id."&order_id=".$order_id;?>" method="post">
                    <label for="amount">Amount:</label><br>
                    <input type="number" id="amount" name="amount" value="10000" readonly><br>

                    <label for="upi_id">UPI ID:</label><br>
                    <div class="upi-input">
                        <input type="email" id="upi_id" name="upi_id" placeholder="123@okhdfcbank" required>
                        <span class="upi-prefix">@upi</span>
                    </div>

                    <input type="submit" name="upi_btn" value="Pay Now">
                </form>
            </div>
