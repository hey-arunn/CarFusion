...
if (isset($_POST['generate_otp'])) {
    ...
    if ($email_id == "") {
        ...
        $check_query = "SELECT `user_email` FROM `users` WHERE `user_email`='$email_id'";
...
if (isset($_POST['submit_otp'])) {
    ...
    if ($input_otp == $stored_otp) {
        ...
        $admin_pass_update_query = "UPDATE `users` SET `user_password`='$input_pass' WHERE `user_email`='$input_email_id'";
