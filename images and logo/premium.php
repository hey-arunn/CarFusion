...
<body>
    ...
    <div class="main-container">
        ...
        <div class="payment-detail-conatiner">
            ...
            <div class="credit">
                <h2>credit card</h2>
                <form action="order_processing.php?mode=credit_card&amount=7000" method="post" id="payment-form">
                    ...
                    <input type="text" id="amount" name="amount" placeholder="7000.00" readonly>
            ...
            <div class="debit">
                <h2>Debit Card</h2>
                <form action="order_processing.php?mode=debit_card&amount=7000" method="post" id="payment-form">
                    <label for="card-holder-name">Card Holder's Name</label>
                    <input type="text" id="card-holder-name" name="card-holder-name" placeholder="Name" required>
                    <label for="card-number">Card Number</label>
            ...
            <div class="upi-form">
                ...
                <form action="order_processing.php?mode=upi&amount=7000" method="post">
                    <label for="amount">Amount:</label><br>
                    <input type="number" id="amount" name="amount" value="7000" readonly><br>
